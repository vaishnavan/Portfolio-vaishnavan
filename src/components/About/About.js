                    ...
                    <div>
                        <div className="about_container">
                            ...
                            <div className="about_content">
                                ...
                                {show ?
                                    <p>As a Full-stack Developer, I have lots of interest in designing website in a very attractive way with animation effects.I have the capability of managing work pressure.
                            I have a very good hands-on experience in both front-end and Back-end development and currently I'm learning GraphQL(Graph Query languange) to expand my skills in API(Application programming Interface) creation.<span onClick={this.read} >ReadLess</span>
                                    </p>
                                    :
                                    <p>As a Full-stack Developer, I have lots of interest in designing website in a very attractive way with animation effects.I have the capability of managing work pressure....<span onClick={this.read} >ReadMore</span></p>
                                }
                            </div>
                        </div>
                        <Interest />
