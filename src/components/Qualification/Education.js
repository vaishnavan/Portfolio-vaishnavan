                        ...
                        <div className="qualification_Topnav">
                            <div style={{ padding: "10px 0" }} className="education_main">
                                <div className="education_proExpericence">
                                    ...
                                    <ul type="circle">
                                        <li>I have been trained in python and Java technologies.</li>
                                        <li>Training was conducted in two parts Generic and Stream.</li>
                                        <li>In Generic ,it was about Python and RDBMS database.</li>
                                        <li>In Stream ,it was about core Java and Spring framework with hibernate.</li>
                                    </ul>
                                </div>
                                <div className="education_proExpericence">
                                    {/* <h2>Professional Experience</h2>
                            <hr /> */}
                                    ...
                                    <ul type="circle">
                                        ...
                                        <li>I was assigned to some Accelarate Project and then, I was Mapped to Bank Sector Project.</li>
                            ...
                            <hr /> */}
                                    ...
                                    <ul type="circle">
                                        <li>Worked as Operations team member in  BT(British Telecommunication) project for 6 months.</li>
                                        <li>Learnt new technologies Like Apache Kafka, Docker.</li>
                                        <li>Started my self-learning in ReactJs and gained knownledge in UI Technologies</li>
